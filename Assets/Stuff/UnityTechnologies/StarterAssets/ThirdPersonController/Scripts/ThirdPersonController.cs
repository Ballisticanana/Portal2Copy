    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (_mainCamera == null)
            {
                if (playerColor == "Red")
                {
                    _mainCamera = GameObject.FindGameObjectWithTag("MainCameraRed");
                }else
                {
                    _mainCamera = GameObject.FindGameObjectWithTag("MainCameraBlue");
                }
            }
        }
        ...
        private void CameraRotation()
        {
            ...
            if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition)
            {
                ...
                _cinemachineTargetPitch += _input.look.y * mouseInvert * deltaTimeMultiplier * lookSpeed;
            }
